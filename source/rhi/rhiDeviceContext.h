...
public:
    ...
    virtual std::unique_ptr<rhiTexture> create_texture_from_path(std::string_view path) = 0;
    ...
    virtual rhiDescriptorPool create_descriptor_pool(const std::vector<rhiDescriptorPoolSize>& sizes, u32 max_sets) = 0;
